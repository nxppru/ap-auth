					...
					<div class="container-fluid">
						...
						<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
							<ul class="nav navbar-nav">
								<li >
									<a href="<?php echo U('Router/router_wifi_config');?>">
							...
							<div class="row">
								<div class="col-xs-12"> 
									...
									<div class="table-responsive">
										...
										<?php echo NW('Table',array( 'columns'=>array( array('name'=>'router_mac','text'=>'路由MAC','width'=>'15%','sortable'=>false), array('name'=>'type','text'=>'类型','width'=>'12%','sortable'=>false), array('name'=>'ret','text'=>'状态','width'=>'12%','sortable'=>false), array('name'=>'content','text'=>'内容','width'=>'26%','sortable'=>false, 'wordwrap'=>true), array('name'=>'create_date','text'=>'创建时间','width'=>'16%','sortable'=>false), ), 'default' => '空', 'rows' => !is_array($list) ? array() : $list , ) ,'Task' );?>
